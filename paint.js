...
var ToolSelect = class ToolSelect {
  constructor(state, { tools, dispatch }) {
    ...
    this.dom = elt("label", null, elt("i", { className: "  icon-gongju" }), "Tool: ", this.select);
  }
...
var ColorSelect = class ColorSelect {
  constructor(state, { dispatch }) {
    ...
    this.dom = elt("label", null, elt("i", { className: "  icon-color" }), "Color: ", this.input);
  }
...
var SaveButton = class SaveButton {
  constructor(state) {
    ...
    this.dom = elt("button", {
      onclick: () => this.save()
    }, elt("i", { className: "  icon-save" }), "Save");
  }
  save() {
...
var LoadButton = class LoadButton {
  constructor(_, { dispatch }) {
    ...
    }, elt("i", { className: "  icon-load" }), " Load");
  }
  syncState() { }
}
...
var UndoButton = class UndoButton {
  constructor(state, { dispatch }) {
    ...
    }, elt("i", { className: " icon-undo" }), "Undo");
  }
  syncState(state) {
...
var startState = {
  tool: "draw",
  color: "#000000",
  picture: Picture.empty(200, 100, "#f0f0f0"),
  done: [],
  doneAt: 0
};
